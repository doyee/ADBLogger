...
class Ui_aboutWiget(object):
    def setupUi(self, aboutWiget):
        ...
        self.label_ico_logger.setGeometry(QtCore.QRect(10, 10, 81, 71))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_home_link.setGeometry(QtCore.QRect(110, 45, 210, 16))
        font = QtGui.QFont()
        ...
        self.widget = QtWidgets.QWidget(aboutWiget)
        self.widget.setGeometry(QtCore.QRect(20, 90, 333, 131))
        ...
        self.lable_name.setGeometry(QtCore.QRect(110, 20, 81, 19))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, aboutWiget):
        ...
        self.label_home_link.setText(_translate("aboutWiget", "<A href=\'https://github.com/doyee/ADBLogger\'> https://github.com/doyee/ADBLogger </a>"))
...
" 把零散的applogcat-log.*日志合并成单一的txt文件方便阅读，设置log等级直接应用到手机等。"))
        ...
        self.lable_name.setText(_translate("aboutWiget", "ADBLogger"))
import app_icons_rc
